...
class SubCategory extends StatefulWidget {
  ...
  const SubCategory({required this.productData, required this.productName, required this.productModel});
        ...
        children: [
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 5,),
              Text("${widget.productData.length} Products",
                ...
                children: [
                  Expanded(child: Row(
                    ...
                    children: [
                      ...
                      SizedBox(width: 5,),
                      Text(widget.productModel,style: SubCategoryStylies.subCategoryModelNameStyle,)
                  ],)),
                  Expanded(
                    child: Row(
