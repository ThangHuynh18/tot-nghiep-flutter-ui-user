...
class TabBarAccept extends StatefulWidget {
  const TabBarAccept({Key? key}) : super(key: key);

  @override
  _TabBarAcceptState createState() => _TabBarAcceptState();
}

class _TabBarAcceptState extends State<TabBarAccept> {
  ...
  Future<Null> getMyOrder() async {
    ...
    final response = await http.get(
      Uri.parse("${AppUrl.baseUrl}/api/orders/myorders/ACCEPT"),
