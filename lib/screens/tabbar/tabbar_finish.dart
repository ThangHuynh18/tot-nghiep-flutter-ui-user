...
class TabBarFinish extends StatefulWidget {
  const TabBarFinish({Key? key}) : super(key: key);

  @override
  _TabBarFinishState createState() => _TabBarFinishState();
}

class _TabBarFinishState extends State<TabBarFinish> {
  ...
  Future<Null> getMyOrder() async {
    ...
    final response = await http.get(
      Uri.parse("${AppUrl.baseUrl}/api/orders/myorders/FINISH"),
