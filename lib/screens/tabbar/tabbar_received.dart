...
class TabBarReceived extends StatefulWidget {
  const TabBarReceived({Key? key}) : super(key: key);

  @override
  _TabBarReceivedState createState() => _TabBarReceivedState();
}

class _TabBarReceivedState extends State<TabBarReceived> {
  ...
  Future<Null> getMyOrder() async {
    ...
    final response = await http.get(
      Uri.parse("${AppUrl.baseUrl}/api/orders/myorders/RECEIVED"),
