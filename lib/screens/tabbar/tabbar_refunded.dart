...
class TabBarRefunded extends StatefulWidget {
  const TabBarRefunded({Key? key}) : super(key: key);

  @override
  _TabBarRefundedState createState() => _TabBarRefundedState();
}

class _TabBarRefundedState extends State<TabBarRefunded> {
  ...
  Future<Null> getMyOrder() async {
    ...
    final response = await http.get(
      Uri.parse("${AppUrl.baseUrl}/api/orders/myorders/REFUNDED"),
