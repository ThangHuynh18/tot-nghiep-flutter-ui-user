...
class TabBarRefunding extends StatefulWidget {
  const TabBarRefunding({Key? key}) : super(key: key);

  @override
  _TabBarRefundingState createState() => _TabBarRefundingState();
}

class _TabBarRefundingState extends State<TabBarRefunding> {
  ...
  Future<Null> getMyOrder() async {
    ...
    final response = await http.get(
      Uri.parse("${AppUrl.baseUrl}/api/orders/myorders/REFUNDING"),
