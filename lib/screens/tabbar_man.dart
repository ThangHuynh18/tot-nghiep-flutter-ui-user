...
//============Tab bar in top for home page==============
class TabBarMan extends StatefulWidget {
  // final List<Products> productData;
  // TabBarBar({required this.productData});

  @override
  State<TabBarMan> createState() => _TabBarManState();
}

class _TabBarManState extends State<TabBarMan> {
  ...
  Future<Null> _fetchData() async {
    ...
    final response = await http.get(
        Uri.parse("${AppUrl.baseUrl}/api/products/category/61547e88bb5aa4086c97dc6b"),
