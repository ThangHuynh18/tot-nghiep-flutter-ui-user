...
class TabBarWoman extends StatefulWidget {
  const TabBarWoman({Key? key}) : super(key: key);

  @override
  _TabBarWomanState createState() => _TabBarWomanState();
}

class _TabBarWomanState extends State<TabBarWoman> {
  ...
  Future<Null> _fetchData() async {
    ...
    final response = await http.get(
        Uri.parse("${AppUrl.baseUrl}/api/products/category/61811040dd4ae50004244d1c"),
