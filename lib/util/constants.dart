...
const String kLastNamelNullError = "Please Enter your name";
const String kPhoneNumberNullError = "Please Enter your phone number";
const String kAddressNullError = "Please Enter your address";
const String kWardNullError = "Please Enter your ward";
const String kDistrictNullError = "Please Enter your district";
const String kCityNullError = "Please Enter your city";
const String kReasonNullError = "Please Enter your reason";
